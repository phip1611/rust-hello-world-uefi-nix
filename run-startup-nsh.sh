...
QEMU_TO_IMG_DIR="./qemu-rt-img-startup-nsh"

rm -rf $QEMU_TO_IMG_DIR
mkdir -p "$QEMU_TO_IMG_DIR/foobar"
...
cp "target/x86_64-unknown-uefi/debug/rust-hello-world-uefi-app.efi" "$QEMU_TO_IMG_DIR/foobar/"
